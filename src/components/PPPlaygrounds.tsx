...
const initiatives: InitiativeItem[] = [
  {
    id: '01',
    number: '01',
    category: 'AI Story Building',
    title: 'Helping Users Find The Right Words',
    summary: 'One of the biggest barriers users faced was knowing what to say.',
    problem: 'Many users knew they wanted to introduce themselves professionally. Few knew how to structure their story or felt comfortable speaking directly to a camera.',
    approach: 'How might we reduce the anxiety associated with creating a professional video introduction?',
    outcome: 'To reduce this friction, I designed a guided workflow where users answer a series of professionally curated career career questions.',
    bulletHeader: 'The system then automatically:',
    bullets: [
      'Structures answer matrices',
      'Transforms responses into a script',
      'Maintains perfect narrative flow',
      'Provides structural formatting'
    ],
    footer: 'Users remain fully in control and can edit any generated content before proceeding.',
    ...
    imageAlts: [
      'AI Question flow and structural prompt layouts',
      'Guided sandbox career blueprint panels',
      'Text builder customization interface'
    ],
    accentColor: '#3B6FD6',
  ...
  },
  {
    id: '02',
    number: '02',
    category: 'Teleprompter Record',
    title: 'Recording With Confidence',
    summary: 'Designing a Low-Stress Recording Experience',
    problem: 'Recording oneself can feel intimidating, especially for users with little experience speaking on camera.',
    approach: 'How might we reduce this pressure to help users focus on delivery?',
    outcome: 'To reduce this pressure, I designed a teleprompter-assisted recording studio.',
    bulletHeader: 'Features included:',
    bullets: [
      'Adjustable script speed',
      'Font controls',
      'Contrast controls',
      'Countdown timer',
      'Pause and resume controls'
    ],
    footer: 'These tools help users focus on delivery rather than memorization.',
  ...
  },
  {
    ...
    summary: 'To support ongoing use, I designed a centralized dashboard where users can:',
    problem: 'One-time video recordings often lack utility beyond a single context. Users need a professional, unified home to revisit their stories and adapt key talking points.',
    approach: 'How might we transition a single-session capture tool into a persistent professional dashboard for personal branding?',
    outcome: 'I designed a centralized desktop dashboard where candidate resources and credentials live.',
    bulletHeader: 'Through this dashboard, users can:',
    bullets: [
      'Manage videos',
      'Update scripts',
      'Access share links',
    ...
    footer: 'The dashboard transforms a one-time recording experience into an ongoing professional branding tool.',
  ...
  },
  {
    id: '04',
    number: '04',
    category: 'Review, Refine & Share',
    title: 'Moving From Recording to Application',
    summary: 'After recording, users enter a review experience where they can evaluate, refine, and prepare their video before sharing it professionally.',
    problem: 'Rather than treating recording as a one-time action, the experience encourages iteration and gives users greater control over their final presentation.',
    approach: 'How might we build a coherent editing-to-sharing pipeline that empowers candidates to iterate until satisfied?',
    outcome: 'By integrating customization features directly into the review workspace, we enable real-time aesthetic adjustments and immediate deployment options.',
    bulletHeader: 'Users can:',
    bullets: [
    ...
    footer: 'The generated link can be easily added to:\n\n• LinkedIn profiles\n• Job applications\n• Cover letters\n• PDF resumes\n\nDesign Consideration\nSharing was intentionally integrated into the review experience, allowing users to move directly from refinement to distribution. By combining editing and sharing within the same workflow, the platform helps users build confidence in their final presentation before sending it to potential employers.',
...
export default function PPPlaygrounds() {
              ...
              >
                ...
                <div className="detail-card-inner space-y-12 h-full lg:overflow-visible transition-none">
                  ...
                  <div 
                    ...
                    className={`w-full max-w-[900px] aspect-[16/10] sm:aspect-[900/640] mx-auto overflow-hidden relative bg-black border border-neutral-900 shadow-2xl flex items-center justify-center group/preview ${initImages.length > 0 ? 'cursor-zoom-in' : ''}`}
                  >
                    ...
                    {/* Carousel Dots */}
                    {initImages.length > 0 && (
                      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2.5 z-20 bg-neutral-950/80 backdrop-blur-md px-3.5 py-2 rounded-full border border-neutral-900 shadow-xl pointer-events-auto max-w-[92%] overflow-x-auto">
            ...
            <div className="relative w-full h-[85vh] md:h-[90vh] flex items-center justify-center px-4 max-w-[95vw] mx-auto">
              ...
              {activeInitImages.length > 1 && (
                <button
                  ...
                  className="absolute right-4 sm:right-8 z-20 p-4 rounded-[6px] bg-neutral-900/60 hover:bg-neutral-800 border border-neutral-800/80 text-white cursor-pointer transition-all hover:scale-110 flex items-center justify-center"
